---
title: "Email Password Credential authentication Setup in Astro.js"
publishedDate: 2024-02-29
updatedDate: 2024-02-29
description: "Step by step guide on how to setup Email Password Credential authentication in astro with email verification and also persist authentication state in astro and protecting routes via middlewares."
...
- User can only send 1 mail per 10 mintues
- User send 1 mail per 10 mintues
...
2. user@example\.com:count: 4

3. user@example\.com:sent: 1709135503827
(timestamp)
...
<p class="my-2 px-3 rounded-md py-2 bg-red-600 text-white ">I am not a cybersecurity expert so please research more before using it in production. If you find any vulnerabilites or you have any suggestions please let me know</p>
...
The route will check for ID if it exists. If their exist an ID then it will update the password and redirect the user to the login page.
