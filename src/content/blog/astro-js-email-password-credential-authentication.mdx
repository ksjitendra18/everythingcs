...
The route will check for ID if it exists. If their exist an ID then it will update the password and will delete all the sessions associated with the userr and then redirect the user to the login page.
