...
Now we will pull the code from github. It is a public repo. In future I will add a guide on how to get code from private repo.
...
I have used this [repo](https://github.com/ksjitendra18/nodejs-host-vps-guide.git) to demonstrate the process. Free free to use it. You will need mongo db atlas db for it to wo
