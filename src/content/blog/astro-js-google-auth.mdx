...
Go to save and continue and move ahead. You need need to input or change any other fields. Go back to dashboard.
...
<img src="https://static.everythingcs.dev/blog/astro-auth-291123/oauth-output.png" alt="oauth screen"/>
