...
<CodeContainer fileName="terminal">
  ```bash npm uninstall tailwindcss postcss autoprefixer ```
</CodeContainer>

For yarn:

<CodeContainer fileName="terminal">
  ```bash yarn remove tailwindcss postcss autoprefixer ```
</CodeContainer>
...
<CodeContainer fileName="terminal">
  ```bash npm i -D tailwindcss postcss autoprefixer or yarn add --dev
...
<CodeContainer>
  ```js content: [ "./app/**/*.{(js, ts, jsx, tsx, mdx)}", "./pages/**/*.
  {(js, ts, jsx, tsx, mdx)}", "./components/**/*.{(js, ts, jsx, tsx, mdx)}", // Or
  if using `src` directory: "./src/**/*.{(js, ts, jsx, tsx, mdx)}", ], ```
</CodeContainer>
