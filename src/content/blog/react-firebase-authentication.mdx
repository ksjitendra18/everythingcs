...
ogImage: "https://staticecs.b-cdn.net/blog/react-firebase-authentication.png"
featuredImage: "https://staticecs.b-cdn.net/blog/react-firebase-authentication.png"
category: ["JavaScript"]
author: "Jitendra"
isFeatured: true
draft: false
...
<img src="https://static.everythingcs.dev/blog/verify-email.png"  loading="lazy"/>
...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // this is a trick to resolve the issue of the
      // onAuthStateChanged when user verifies their email and login then
      //it does not changes as it is same as signup
      await signOut(auth);
      setIsLoading(true);
