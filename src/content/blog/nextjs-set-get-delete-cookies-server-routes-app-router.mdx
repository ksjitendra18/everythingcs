...
<CodeContainer>```js import {cookies} from "next/headers"; ```</CodeContainer>
...
<p class="bg-red-500  text-white rounded-md px-3 py-2">
  Please note that you can perform this action in server actions and route
  handlers only. It will throw error even if it is a server component.{" "}
</p>
...
<video muted controls>
  <source
    src="https://staticecs.b-cdn.net/blog/next-cookies-get-set-241023/server-component-cookies-get-set.mp4"
    loading="lazy"
  />
</video>
