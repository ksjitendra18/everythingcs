...
ogImage: "https://static.everythingcs.dev/blog/get-form-input-values-react-next-validate-zod"
featuredImage: "https://static.everythingcs.dev/blog/get-form-input-values-react-next-validate-zod"
category: ["JavaScript"]
author: "Jitendra"
isFeatured: true
draft: false
...
I have provided you the simple react vite setup with the typescript and tailwind. Download the repo from [github](https://github.com/ksjitendra18/form-handling-react).
...
```jsx
const [formError, setFormError] = useState<z.ZodFormattedError<FormSchema, string>>();
...
So in this post we learnt how to handle forms in react and how to get values from input. In this post we also implemented the validation using zod library.
