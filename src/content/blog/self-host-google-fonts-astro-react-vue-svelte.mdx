...
<CodeContainer fileName="terminal">
  ```bash npm install @fontsource/roboto # installing variable fonts npm install
...
<CodeContainer fileName="terminal">
  ```js --- import '@fontsource/roboto/400.css'; import
  '@fontsource/roboto/500.css'; import '@fontsource/roboto/600.css'; import
  '@fontsource/roboto/700.css'; --- ```
</CodeContainer>

To install variable font we just have to import one file

<CodeContainer fileName="terminal">
  ```js --- import '@fontsource-variable/plus-jakarta-sans'; --- ```
</CodeContainer>
